...
class Player:
    ...
    def play(self, dealerCard):
        ...
        self.dealrcard = random.choice(cards)
        ...
        if playerCard < dealerCard:
            ...
            return 'player' + str(self.playerID) + 'Lost'
        else:
            self.playerPot += gameStake
            return 'player' + str(self.playerID) + 'Win'
...
def playHand(players):
    ...
    for player in players:
        ...
        return player.play(random.choice(cards))
...
def checkBalances(players):
    ...
    for player in players:
        ...
        print 'Player ' + str(player.playerID) + ' has ' + str(player.playerPot) + ' left.'
